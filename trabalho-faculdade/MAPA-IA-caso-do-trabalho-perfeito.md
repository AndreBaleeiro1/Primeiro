# MAPA – Missão Científica: O Caso do Trabalho Perfeito

> **Rascunho-base.** Antes de entregar:
> 1. Baixe o **formulário-padrão** no Material da Disciplina e passe o texto para ele.
> 2. Troque/complete os pontos marcados com 📘 com conceitos das **Unidades 2 e 3** do livro.
> 3. Personalize a **Questão 4** (pontos 📝) com exemplos seus.
> 4. Releia tudo e confira se consegue explicar cada frase.
>
> **Prazo:** entregar até amanhã à noite.

---

## Questão 1 – Quatro problemas na produção do conhecimento científico

**1. Uso de referências inexistentes (sem checar as fontes).**
...
## Questão 2 – Texto de 5 a 8 linhas

Pedro cometeu erros graves no processo de pesquisa: delegou integralmente a produção do texto à IA, não consultou artigos científicos, não verificou a veracidade das informações e não conferiu as referências, que se revelaram inexistentes. Com isso, abriu mão do pensamento crítico e da autoria do próprio trabalho, a ponto de não conseguir explicá-lo. A IA poderia ter sido usada de forma ética e eficiente como apoio, e não como substituta: para organizar ideias iniciais, sugerir palavras-chave de busca, ajudar a estruturar o texto e revisar a escrita. As informações, porém, deveriam ser confirmadas em bases confiáveis, como Google Acadêmico, SciELO e Periódicos CAPES, e o uso da ferramenta deveria ser informado com transparência ao professor.

*(Cerca de 7 linhas no formulário com fonte 12. Ajuste se passar.)*

---

## Questão 3 – Duas recomendações para o Pedro

**Recomendação 1: Usar a IA como ponto de partida e sempre verificar as informações em fontes científicas.**
Pedro pode pedir à IA uma visão geral do tema, termos-chave e possíveis caminhos de pesquisa, mas deve confirmar cada dado e cada referência em bases confiáveis antes de usar.
*Benefício para a aprendizagem:* a IA agiliza a fase exploratória e, ao conferir as informações, o estudante desenvolve senso crítico, aprende a avaliar fontes e passa a entender o conteúdo de verdade.

**Recomendação 2: Manter a autoria e ser transparente sobre o uso da IA.**
O texto deve ser escrito pelo próprio estudante, com suas análises e conclusões. A IA pode servir para revisar a gramática, sugerir melhorias na estrutura ou explicar conceitos difíceis, como um "tutor". Além disso, o uso da ferramenta deve ser declarado, seguindo as regras da instituição.
*Benefício para a aprendizagem:* o estudante recebe feedback rápido, esclarece dúvidas e melhora a escrita sem terceirizar o raciocínio. A aprendizagem fica mais ativa e personalizada, e a integridade acadêmica é preservada.
...
## Referências (reais – conferir antes de usar)
